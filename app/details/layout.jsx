...
import pharmacy from "../../../Public/images/national-cancer-institute-byGTytEGjBo-unsplash.jpg";
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 mt-32 gap-6">
        ...
        <div className="col-span-1 lg:col-span-4">
          ...
          <div className="bg-white p-6 shadow-lg rounded-2xl backdrop-blur-md">
            ...
            {/* زر التواصل */}
            <button className="mt-6 w-full bg-gradient-to-r from-purple-600 to-pink-500 text-white py-3 rounded-lg shadow-md hover:scale-105 transition">
              تواصل معنا
            </button>
          </div>
        </div>
