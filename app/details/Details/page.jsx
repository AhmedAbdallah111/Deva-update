export default function DetailsPage() {
  return (
    <div className="space-y-6">
      ...
      <div className="border border-gray-300 rounded-xl overflow-hidden shadow-lg">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 text-right text-gray-700 text-sm">
          {[
            "بكالوريوس",
            "TR-NQF-HE: المستوى 7",
            "QF-EHEA: الدورة الثانية",
            "EQF-LLL: المستوى 7",
          ].map((text, index) => (
            <span
              key={index}
              className="p-3 border border-gray-300 font-medium bg-gray-50 whitespace-nowrap overflow-hidden text-ellipsis"
            >
              {text}
            </span>
          ))}
      ...
      <h2 className="text-2xl text-right text-[#a21caf] font-bold">
        هيكل المقررات الدراسية مع النقاط المعتمدة
      </h2>
      ...
      <div className="rounded-xl overflow-hidden shadow-lg overflow-x-auto">
        ...
        {[
          [
            "ENG1003",
            "مهارات وإعداد التقارير الأكاديمية I",
            "الإنجليزية",
            "-",
            "2",
            "2",
          ...
          [
            "HST1001",
            "مبادئ أتاتورك وتاريخ الجمهورية التركية I",
            "الإنجليزية",
            "-",
            "2",
            "0",
            ...
            {course.map((item, i) => (
              ...
              >
                {i === 0 ? (
                  <a
                    href="#"
                    className="text-[#a21caf] font-medium hover:underline"
                  >
                    {item}
                  </a>
                ) : (
