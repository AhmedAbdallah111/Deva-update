...
import logo from "../../Public/images/Sabahattin-Zaim-University.jpg";
import cover from "../../Public/images/Sabahattin-Zaim.jpg";
import altnnn from "../../Public/images/sab4.jpg";
import altsss from "../../Public/images/sab3.jpg";
import altn from "../../Public/images/sab2.jpg";
import alt from "../../Public/images/sab1.jpg";
import awrak from "../../Public/images/awark.jpg";
import { useTranslation } from "react-i18next";
const images = {
  ar: { cover: cover },
  en: { cover: "/images/zaaim_en.png" },
  fr: { cover: "/images/sabahzaam_fr.png" },
  fa: { cover: "/images/istanzam_fa.png" },
  tr: { cover: "/images/istanzaam_tr.png" },
  ru: { cover: "/images/zaim_ru.png" },
};
const sabah = () => {
      ...
      <div className="grid grid-cols-1 gap-4 lg:grid-cols-3 lg:gap-8 my-10  -mt-0 pt-24 max-lg:w-[75rem] max-lg:mr-6">
        <div className="h-auto rounded-lg bg-gradient-to-r from-purple-50 to-pink-50  lg:col-span-2 max-[1366px]:grid-cols-1">
          ...
          <div className="flex text-center items-center justify-center">
            <h1 className="text-red-600 font-bold text-4xl mt-2 mb-1">
              {t("جامعة صباح الدين زعيم في تركيا")}
            </h1>
          </div>
        ...
        <div className="h-auto rounded-lg bg-gradient-to-r from-purple-50 to-pink-50 ml-4">
          <iframe
            ...
            src="https://www.youtube.com/embed/7n_iNDgfgNM?si=_bjWL6tC3yKM97FE"
            allowFullScreen
          />
          ...
          <div className=" flex my-5">
            ...
            <h1 className="font-bold text-gray-900 text-2xl pr-4 mt-2 max-sm:text-3xl">
              {t("التصنيف العالمي:")}
              <b className="text-xl text-gray-500 max-sm:text-3xl">3434</b>
            </h1>
          </div>
          <hr />
          <div className=" flex my-5">
            ...
            <h1 className="font-bold text-gray-900 text-2xl pr-4 mt-2 max-sm:text-3xl">
              {t("التصنيف المحلي:")}
              <b className="text-xl text-gray-500 max-sm:text-3xl">112</b>
            </h1>
          </div>
          <hr />
          <div className=" flex my-5">
            ...
            <h1 className="font-bold text-gray-900 text-2xl pr-4 mt-2 max-sm:text-3xl">
              ...
              <b className="text-xl text-gray-500 max-sm:text-3xl">41</b>
            </h1>
          </div>
          <hr />
          <div className=" flex my-5">
            ...
            <h1 className="font-bold text-gray-900 text-2xl pr-4 mt-2 max-sm:text-3xl">
              {t("عدد الطلاب :")}
              <b className="text-xl text-gray-500 max-sm:text-3xl">9,893</b>
            </h1>
          </div>
          <hr />
          <div className=" flex my-5">
            ...
            <h1 className="font-bold text-gray-900 text-2xl pr-4 mt-2 max-sm:text-3xl">
              ...
              <b className="text-xl text-gray-500 max-sm:text-3xl">2270</b>
            </h1>
          </div>
        </div>
      </div>
      <div className="grid bg-gradient-to-r from-violet-50 h-auto w-[96%] mr-[2%] to-fuchsia-50 rounded-lg mt-9 max-sm:w-[75rem] max-sm:mr-6 max-lg:w-[75rem]">
        <div className="mr-5 bg-fuchsia-900 w-fit px-6 mt-5 h-14 rounded-tr-lg rounded-bl-lg">
          <h1 className="font-bold text-3xl text-yellow-500 pr-2 pl-4 py-2">
            {t("معلومات عامة عن جامعة صباح الدين زعيم")}
          </h1>
        </div>
        <div className="grid grid-cols-1 gap-4 lg:grid-cols-3 lg:gap-8">
          <div className=" rounded-l lg:col-span-2">
            ...
            <p className="text-gray-700 font-medium text-xl py-4 mr-5">
              {t(
                "تأسست جامعة إسطنبول صباح الدين زعيم الوقفية على أراضي تابعة لوقف السلطان بيازيد الثاني من قبل وقف علم يايما عام 2010 لتحمل اسم البروفيسور صباح الدين زعيم، والذي يعد أحد مؤسسي وقف علم يايما وأحد قيادات التيار الإسلامي في خمسينيات القرن الماضي. وتعتبر الجامعة جامعة وقفية بالدرجة الأولى، حيث تمنح لطلابها منحًا تتراوح بين 25% و100% على الرسوم الدراسية. تضم الجامعة ثماني كليات ومعهدًا عاليًا لمرحلة الدراسات."
              )}
            </p>
            ...
            <p className="text-gray-700 font-medium text-xl py-4 mr-5">
              {t(
                "جامعة صباح الدين زعيم تقع في مدينة إسطنبول، تركيا. الحرم الجامعي الرئيسي يتميز بطابع معماري عثماني فريد ومساحات خضراء واسعة. وهو يوفر بيئة تعليمية حديثة ومجهزة بمرافق متطورة لتلبية احتياجات الطلاب. يقع الحرم الجامعي الرئيسي في منطقة هالكالي بالجزء الأوروبي من إسطنبول، ويوجد داخله مكتبة مركزية تحتوي على موارد أكاديمية رقمية ومطبوعة."
              )}
              <br />
              {t("قاعات دراسية حديثة ومجهزة")} \ {t("مختبرات للبحث العلمي")} \{" "}
              {t("مساجد داخل الحرم")} \ {t("مرافق رياضية وترفيهية")}
            </p>
          </div>
        ...
        <div className="w-[80%]">
          <div className="space-y-4">
            ...
            >
              <summary className="flex cursor-pointer items-center justify-between gap-1.5">
                <h2 className="text-2xl font-bold text-fuchsia-950">
                  {t("لغات التدريس في جامعة صباح الدين زعيم؟")}
                </h2>
              ...
              <p className="mt-4 leading-relaxed text-xl font-bold text-gray-700">
                {t(
                  "اللغات المعتمدة في جامعة صباح الدين زعيم هي الإنجليزية أو التركية، ويحدد ذلك بناءً على التخصص المطلوب واختيار الطالب."
                )}
              </p>
            ...
            >
              <summary className="flex cursor-pointer items-center justify-between gap-1.5">
                <h2 className="text-2xl font-bold text-fuchsia-950">
                  {t("اعترافات جامعة صباح الدين زعيم")}
                </h2>
              ...
              <h1 className="font-bold text-xl text-gray-800">
                {t(
                  "جامعة صباح الدين زعيم هي واحدة من الجامعات التركية المعترف بها، ولها اعتمادات متعددة على المستويين المحلي والدولي. فيما يلي أهم التفاصيل حول اعتماد الجامعة:"
                )}
              </h1>
              <p className="mt-4 leading-relaxed text-xl font-bold text-gray-700">
                ...
                <br />
                {t(
                  "الجامعة معترف بها في العديد من الدول العربية، مثل السعودية، العراق، الأردن، مصر، ودول الخليج الأخرى. هذا يجعل شهاداتها مقبولة للعمل والدراسات العليا في هذه الدول."
                )}

                <br />
                {t(
                  "الجامعة عضو في برامج التبادل الطلابي الأوروبية مثل Erasmus+، مما يسمح لطلابها بالدراسة في جامعات أوروبية معترف بها."
                )}
              </p>
            </details>
            <details
            ...
            >
              ...
              <p className="mt-4 leading-relaxed text-xl font-bold text-gray-700">
                {t(
                  "السكن الطلابي في جامعة صباح الدين زعيم يقدم بيئة مريحة وآمنة للطلاب، خاصة للطلاب الدوليين، مع مراعاة توفير كافة الخدمات التي تساعد الطلاب على التركيز في دراستهم. فيما يلي أهم التفاصيل:"
                )}
                <br />
                {t(
                  "يوجد داخل الحرم الجامعي خيارات سكن للطلاب والطالبات. الغرف متاحة بأحجام مختلفة (غرف فردية، مزدوجة، ثلاثية). السكن مزود بجميع وسائل الراحة الأساسية مثل التدفئة، الإنترنت، والأثاث."
                )}
              </p>
            ...
            >
              ...
              <p className="mt-4 leading-relaxed text-xl font-bold text-gray-700">
                {t(
                  "الحياة الطلابية في جامعة صباح الدين زعيم غنية بالتجارب والأنشطة التي تعزز من تجربة الطلاب الأكاديمية والاجتماعية، وتجعلها ممتعة ومليئة بالتنوع الثقافي"
                )}

                <p className="leading-relaxed  font-medium text-[18px] text-gray-700">
                  <br />
                  {t(
                    "تضم الجامعة عددًا كبيرًا من الأندية الطلابية، مثل أندية الرياضة، الثقافة، التكنولوجيا، الفن، واللغات"
                  )}
                </p>
                <p className="leading-relaxed  font-medium text-[18px] text-gray-700">
                  {t(
                    "تنظيم ندوات، ورش عمل، ومسابقات علمية وثقافية. رحلات داخلية وخارجية لاستكشاف معالم إسطنبول وتركيا. مهرجانات طلابية ومناسبات دينية وثقافية تعكس التنوع الثقافي."
                  )}
                </p>
                <p className="leading-relaxed  font-medium text-[18px] text-gray-700">
                  {t("ملاعب كرة قدم، كرة سلة، تنس، وصالات رياضية مجهزة")}
                </p>
                <p className="leading-relaxed  font-medium text-[18px] text-gray-700">
                  {t(
                    "مساحات خضراء داخل الحرم ومقاهي توفر بيئة مريحة للاجتماعات والدراسة"
                  )}
                </p>
              </p>
            ...
            >
              <summary className="flex cursor-pointer items-center justify-between gap-1.5">
                <h2 className="text-2xl font-bold text-fuchsia-950">
                  {t("مميزات الدراسة في جامعة صباح الدين زعيم")}
                </h2>
              ...
              <p className="mt-4 leading-relaxed text-xl font-bold text-gray-700">
                <br />
                {t(
                  "الجامعة تضم طلابًا من مختلف الجنسيات، مما يعزز فرص التعرف على ثقافات متنوعة وتكوين صداقات دولية"
                )}

                <br />
                {t(
                  "تقدم الجامعة عددًا من المنح الدراسية للطلاب المتفوقين، بما في ذلك الطلاب الدوليين، مما يجعل التعليم ميسور التكلفة"
                )}

                <br />
                {t(
                  "توفر الجامعة فرصًا للتدريب والتوظيف بالتعاون مع مؤسسات كبرى"
                )}
                <br />
                {t(
                  "الجامعة تركز على الجمع بين القيم الأخلاقية الإسلامية والتعليم الحديث وتشجيع البحث والابتكار مع التمسك بالمسؤولية الاجتماعية"
                )}
              </p>
            ...
            >
              <summary className="flex cursor-pointer items-center justify-between gap-1.5">
                <h2 className="text-2xl font-bold text-fuchsia-950">
                  {t("الأوراق المطلوبة للتقديم على جامعة صباح الدين زعيم")}
                </h2>
            ...
            >
              <summary className="flex cursor-pointer items-center justify-between gap-1.5">
                <h2 className="text-2xl font-bold text-fuchsia-950">
                  {t("كليات وتخصصات جامعة صباح الدين زعيم")}
                </h2>
