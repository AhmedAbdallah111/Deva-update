...
const Qustiton = () => {
  ...
  return (
    <>
      <div className=" px-2 py-32 sm:px-6 lg:px-8 flex justify-between max-sm:w-[80rem] max-lg:w-[79rem] bg-[#dcc0c02c">
        <Image
          src={rig}
        ...
        <div className="relative overflow-hidden bg-white w-fit shadow-2xl rounded-3xl">
          ...
          <div className="relative z-10 p-8 text-center md:p-16 lg:p-20">
            ...
            <a
              href="../Dalil"
              className="inline-block cursor-pointer px-8 py-4 text-lg font-semibold text-white transition-all duration-200 bg-[#7a0066c6] rounded-xl hover:bg-fuchsia-950 hover:shadow-lg transform hover:-translate-y-0.5"
            >
              {t("اضغط هنا")}
            </a>
          </div>
