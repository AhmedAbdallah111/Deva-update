...
import altnnn from "../../Public/images/Ankara-Medipol-University-3.webp";
import altsss from "../../Public/images/ankara-medipol-campus.jpeg";
  ...
  return (
    <>
      <div className="grid grid-cols-1 gap-4 lg:grid-cols-3 lg:gap-8 my-10  -mt-0 pt-24 max-lg:w-[75rem] max-lg:mr-6">
        ...
        <div className="h-auto rounded-lg bg-gradient-to-r from-purple-50 to-pink-50 ml-4 max-w:[75rem] max-lg:w-[75rem]">
          <iframe
            className="w-11/12 mr-5 h-60 rounded-lg mt-4 max-sm:h-[30rem] max-lg:h-[30rem]"
            src="https://www.youtube.com/embed/igedUowq5WQ"
            allowFullScreen
          />
        ...
        <div className="grid grid-cols-1 gap-4 lg:grid-cols-3 lg:gap-8">
          <div className=" rounded-l lg:col-span-2">
            ...
            <p className="text-gray-700 font-medium text-xl py-4 mr-5">
              {t(
                "يقع الحرم الجامعي الرئيسي لجامعة أنقرة ميديبول والذي يسمى  أنافارتالار Anafartalar داخل حدود منطقة ألتين داغ، في وسط العاصمة التركية أنقرة، والذي يعد موقعًا مميزًا للغاية."
              )}
            </p>
            ...
            <p className="text-gray-700 font-medium text-xl py-4 mr-5">
              {t(
                "تسعى جامعة أنقرة ميديبول وراء تحقيق أهداف قيمة ومميزة لطلابها  ولمجتمع العلوم وللدولة، وهذا من خلال توفير مناهج تعليمية تتضمن النظرية والنظرية الأخرى لينعكس ذلك على الطلاب ورحلتهم في المستقبل وتقبل الآخر والاختلافات."
              )}
              <hr className="my-2" />
              <br className="" />
            </p>
            ...
            <p className="text-gray-700 font-medium text-xl py-4 mr-5">
              {t(
                "رؤية الجامعة أن تصبح من أفضل جامعات تركيا الرائدة والتي لها أثر كبير على توجيه الطلاب والمجتمع نحو التعلم والثقافة المستمرة."
              )}
              <hr className="my-2" />
              <br className="" />
            </p>
      ...
      <div className="grid bg-gradient-to-r from-violet-50 h-auto w-[96%] mr-[2%] to-fuchsia-50 rounded-lg mt-9 max-w:[75rem] max-lg:w-[75rem]">
          ...
          <div className="space-y-4">
            ...
            >
              ...
              <p className="mt-4 leading-relaxed text-xl font-bold text-gray-700">
                {t(
                  " اللغات المعتمدة في جامعة انقره ميدبول الإنكليزية أو التركية ويحدد ذلك بناءً على التخصص المطلوب واختيار الطالب."
                )}
              </p>
            ...
            >
              ...
              <h1 className="font-bold text-xl text-gray-800">
                {t(
                  "اختيارك للدراسة في جامعة ميديبول يعتبر اختياراً صائباً؛ ذلك لأن الجامعة حصلت على مجموعة كبيرة من الاعتمادات الدولية، وأهم تلك  الاعتمادات ما يلي:"
                )}
              </h1>
              <p className="mt-4 leading-relaxed text-xl font-bold text-gray-700">
                {t(
                  "اعتماد JCI، الذي حصلت عليه مستشفى جامعة ميديبول ميجا في عام 2014."
                )}
                <br />
                <hr className="my-2" />

                {t(
                  "شهادة جودة TOTEK، وهي اعتماد مخصص من أجل زيادة جودة تعليم تخصص جراحة العظام والكسور في الجامعات."
                )}
                <br />
                <hr className="my-2" />

                {t(
                  "اعتماد FIBAA، وهو اعتماد أوروبي يهدف إلى تطبيق جودة التعليم في مجالات مثل، الإدارة والاقتصاد والقانون والعلوم الاجتماعية."
                )}
                <br />
                <hr className="my-2" />
            ...
            >
              ...
              <p className="mt-4 leading-relaxed text-xl font-bold text-gray-700">
                {t(
                  "تأسست جامعة أنقرة ميديبول عام 2018 من قبل مؤسسة التعليم والصح والعلوم والبحوث التركية في مدينة انقرة التركية."
                )}
              </p>
            ...
            >
              ...
              <p className="mt-4 leading-relaxed text-xl font-bold text-gray-700">
                {t(
                  "توفر الجامعة لطلابها العديد من النوادي الرياضية كنادي السباحة وكرة القدم والعديد من الرياضات إضافة لملء أوقات الفراغ لطلابها كما توفر نوادي فكرية لطلابها لتبادل وجهات النظر وللأسف لا تمتلك الجامعة مرافق رياضية خاصة بها"
                )}
                <br />

                {t(
                  "تعد منطقة Altındağ هي المدينة القديمة من مدينة أنقرة حيث يقع فيها حي Ulus والذي يعتبر مركز مدينة أنقرة قبل تسعينات القرن الماضي ويوجد فيها العديد من الشوارع والميادين التي تتواجد العديد من المقاهي"
                )}
                <br />

                {t(
                  "يوجد في منطقة Altındağ العديد من المناطق الأثرية منها قلعة أنقرة والتي يعود إنشاؤها لقرنين قبل الميلاد والتي أصبحت معقلا للعديد من الإمبراطوريات الرومانية والبيزنطينية والسلجوقية والعثمانية وتعتبر من أهم معالم مدينة أنقرة والتي ينصح بزيارتها فهي تقع على مرتفع تطل على أرجاء المدينة. كما يوجد في المنطقة العديد من المتاحف كمتحف Rahmi Koç متحف Altınköy المفتوح والتي تعرض فيها جوانب من الحياة الريفية التركية"
                )}
                <br />
              </p>
