      ...
      <div className="grid grid-cols-1 gap-4 lg:grid-cols-3 lg:gap-8 my-10  -mt-0 pt-24 max-lg:w-[75rem] max-lg:mr-6">
        <div className="h-auto rounded-lg bg-gradient-to-r from-purple-50 to-pink-50  lg:col-span-2 max-[1366px]:grid-cols-1">
          ...
          <div className="text-center flex justify-center items-center my-4">
            ...
            <h4 className="font-bold text-gray-800 text-xl">{t("أنقره")}</h4>
            <svg
              xmlns="http://www.w3.org/2000/svg"
              viewBox="0 0 512 512"
      ...
      <div className="grid bg-gradient-to-r from-violet-50 h-auto w-[96%] mr-[2%] to-fuchsia-50 rounded-lg mt-9 max-lg:mr-6 max-lg:w-[75rem]">
        ...
        <div className="grid grid-cols-1 gap-4 lg:grid-cols-3 lg:gap-8">
          <div className=" rounded-l lg:col-span-2">
            ...
            <p className="text-gray-700 font-medium text-xl py-4 mr-5">
              {t(
                "يقع في منطقة كزلجاشار Kızılcaşar، أحد أحياء غول باشا في العاصمة التركية أنقرة، ويتميز بالآتي:"
              )}
              <hr className="my-2" />
              <br className="" />

              {t(
                "1-المساحة الخضراء الكبيرة الممتدة إلى أكثر من 250 ألف متر مربع ممّا يهيئ الطلاب نفسياً للدراسة."
              )}
              <br />
              <hr className="my-2" />
              <br />
              ...
              {t(
                "2-يحتوي على 67 نادياً، ومجتمعاً طلابياً لتوفير جميع التسهيلات، وأدوات المعرفة اللازمة للطلاب."
              )}
              <br />
              <hr className="my-2" />

              {t(
                "3-يحتوي على عدد 5 كافتيريا كبيرة ذات جودة عالية تقوم بخدمة ما يصل إلى 5000 فرد."
              )}
              <hr className="my-2" />

              {t(
                "4-يحتوي على واحدة من أكبر، وأجمل المكتبات في أنقرة؛ وهي مكتبة قادرية زعيم، والتي تبلغ مساحتها ما يقارب ال 8000 متر مربع."
              )}
              <br />
            </p>
          </div>
          ...
          <div className="space-y-4">
            ...
            >
              ...
              <p className="mt-4 leading-relaxed text-xl font-bold text-gray-700">
                {t(
                  "اللغات المعتمدة في جامعة أتيليم الإنكليزية أو التركية ويحدد ذلك بناءً على التخصص المطلوب واختيار الطالب."
                )}
              </p>
            ...
            >
              ...
              <p className="mt-4 leading-relaxed text-xl font-bold text-gray-700">
                ...
                {t(
                  "إعتماد MÜDEK وهو إعتماد خاص بتدريس العلوم الهندسية في كلية الهندسة."
                )}
              </p>
            </details>
            <details
            ...
            >
              ...
              <p className="mt-4 leading-relaxed text-xl font-bold text-gray-700">
                {t(
                  "تهتم جامعة أتيليم بتكوين علاقات قوية بين الطلاب وإدارة الجامعة، وإجراء حوار مستمر مع الطلاب لمعرفة احتياجاتهم وتلبيتها. كما توفر الجامعة حياة طلابية نشطة وممتعة وتعمل على تطويرها، من خلال ما يلي:"
                )}
                ...
                <p className="leading-relaxed  font-medium text-[18px] text-gray-700">
                  {t(
                    "تتيح الجامعة فرصة التقديم على برامج التبادل الطلابي والدراسة خارج تركيا."
                  )}
                </p>
                <p className="leading-relaxed  font-medium text-[18px] text-gray-700">
                  {t(
                    "جامعة اتيليم معتمدة من الشبكة الأوروبية لاعتماد التعليم الهندسي (ENAEE)، وحصلت الجامعة على اعتماد 8 أقسام في كلية الهندسة من قبل جمعية تقييم واعتماد البرامج الهندسية MUDEK."
                  )}
                </p>
                <p className="leading-relaxed  font-medium text-[18px] text-gray-700">
                  {t(
                    "تتدعم الجامعة منحة الايراسموس للتبادل الطلابي مع 120 جامعة من الجامعات الأوربية"
                  )}
                </p>
              </p>
            ...
            >
              ...
              <p className="mt-4 leading-relaxed text-xl font-bold text-gray-700">
                {t(
                  "تتميز جامعة أتيليم بمناهجها القوية التي تحدثها سنويًا؛ من أجل أن يتلقى الطالب آخر ما وصل إليه العلم في التخصص الذي يدرسه."
                )}
                <br />
                ...
                {t(
                  "توفر الجامعة فرصة البحث العلمي لطلبة البكالوريوس من خلال برنامج مشاريع البحوث الجامعية، وذلك بهدف إكسابهم بالخبرة المهنية المطلوبة لحياتهم المهنية بعد التخرج."
                )}
                <br />

                {t(
                  "دعم مشاريع البحث المشتركة بين معاهد الدراسات العليا بالجامعة والمنظمات المحلية المختلفة"
                )}
                <br />

                {t(
                  "تعليم عالي المستوى في مختلف التخصصات الأكاديمية وتقديم معظمها باللغة الإنجليزية"
                )}
              </p>
                    ...
                    <div className="mt-8 grid grid-cols-1 gap-4 md:grid-cols-3 md:gap-8 max-sm:grid-cols-2">
                      ...
                      <blockquote className="rounded-lg bg-gray-50 p-6 shadow-sm sm:p-8">
                        ...
                        <div className="mt-4 flex">
                          ...
                          <p className="text-gray-600 text-sm pr-1 mt-1 font-medium">
                            <b className="text-red-600">{t("أتيليم")}</b>
                          </p>
                        </div>
                        <hr className="my-2" />
                        <div className="mt-4 text-gray-800 font-semibold text-lg">
